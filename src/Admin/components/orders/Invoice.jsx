...
import { getOrder, orderSingleSelector } from '../../store/reducers/ordersSlice';
        ...
        <Wraper>
            ...
            <Header>
                <Status>
                    ...
                    <Address>
                        <H1 textAlign='right'>Đơn vị vận chuyển</H1>
                        <P textAlign='right'>
                            UTE Pharmacy, Số 1, Đường Võ Văn Ngân, TP.Thủ Đức
                ...
                <Info>
                    <WraperInfo>
                        <HeadingInfo>Thời gian</HeadingInfo>
                        <ContentInfo>{order.date}</ContentInfo>
                    </WraperInfo>
                    <WraperInfo>
                        <HeadingInfo>Mã đơn hàng</HeadingInfo>
                        <ContentInfo>#{order.order_id}</ContentInfo>
                    </WraperInfo>
                    <WraperInfo>
                        <HeadingInfo textAlign='right'>Khách hàng</HeadingInfo>
