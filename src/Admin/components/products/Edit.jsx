...
import { deleteImg, getSingleProduct, singleProductsSelector, updateProduct } from '../../store/reducers/productsSlice';
import { Box, Button, CircularProgress, Fab, TextField, Tooltip } from '@mui/material';
        ...
        <>
            <Wrap className='mb-10'>
                ...
                <Container>
                    ...
                    >
                        <Fab color='primary' aria-label='add' onClick={() => handleUpdateProduct()}>
                            <DoneIcon />
                        </Fab>
                    </Box>
